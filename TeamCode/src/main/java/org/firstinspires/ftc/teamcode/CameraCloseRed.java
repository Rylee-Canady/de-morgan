    ...
    public void runOpMode() {
        ...
        if(opModeIsActive() == true){
            ...
            //if object is in the middle
                ...
                sleep(20);
                resetEncoders();
                strafeLeft(710,.4,true);
                score();
                IMUTurn(-90,.1);
                while(distSensor.getDistance(DistanceUnit.CM) >= 8){
                    move(.1);
                }
                resetEncoders();
                sleep(1000);
...
/*
    ...
    */
    ...
    public void initialize() {
        ...
        LClaw.scaleRange(0.42, 0.55);
        RClaw.scaleRange(0.0, 0.12);
        Wrist.scaleRange(0.112, 0.75);
        resetEncoders();
        imu.resetYaw();
    }//end initialize
